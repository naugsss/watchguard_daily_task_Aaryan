...
def increment_manager():
    ...
    while True:
        ...
        counter_queue.task_done() # this unlocks the queue, now another thread could go back and get something if they wanted tox``

Thread(target=increment_manager, daemon=True).start() 
# daemon means that it is going to run for infinite time until we found an error
