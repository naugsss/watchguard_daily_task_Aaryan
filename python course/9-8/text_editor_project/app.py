...
def create_file(content="", title="untitled"):
    ...
    # here we are actually storing the hash of the file content written by the user.
    # this will help us in a way that if the file content changes then the hash of the
    # file changes
...
def save_file():
    ...
    try:
        ...
        text_widget = get_text_widget()
        # this means to start with the 1st line from the 0th char and go till the end, except the last char because
        # last char is always a new line char, and we do not need that new line character
        content = text_widget.get("1.0", "end-1c")
...
def show_about_info():
    messagebox.showinfo(
        title='About',
        message="The text editor is a simple tabbed text editor designed to practice Tkinter."
    )
...
# this is for file, edit, view...
menubar = tk.Menu()
root.config(menu=menubar)

# this method will just create a file option and add it inside our menubar
